...
from resoures.user_logout import UserLogout
...
# This wiil be called every time a token is send to an endpoint, return true only if the token has been revoked.
@jwt.token_in_blacklist_loader
def is_the_token_revoked(decrypted_token):
    return BlackListedJWIModel.is_blacklisted(decrypted_token["jti"])
